...
<table width="1359" border="0">
  ...
  <tr>
    ...
    <form action="<?=$_SERVER['PHP_SELF']?>" method="POST">
    <div align="center"><a href="http://engineering.missouri.edu/" rel="home"><font size="4" color="White"><strong>Sort data by prole characteristics</strong></font><br><br></a></div>
    ...
    <div align="center"><a href="http://engineering.missouri.edu/" rel="home"><font size="4" color="White"><strong>General user statistics</strong></font><br><br></a></div>
